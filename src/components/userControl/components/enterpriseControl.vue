    ...
    <el-table
      ...
      <el-table-column
        ...
        <template slot-scope="scope">
          ...
          <!--<el-button type="danger" v-show="scope.row.status=='正常'" size="small"-->
          <!--@click="handleFreeze(scope.row.userId)">冻结-->
          <!--</el-button>-->
          <!--<el-button type="danger" v-show="scope.row.status=='冻结'" size="small"-->
          <!--@click="handleUnfreeze(scope.row.userId)">-->
          <!--解冻-->
          <!--</el-button>-->
